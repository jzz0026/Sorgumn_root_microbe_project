...
bbduk.sh in=out_0001_r_trimmed.fq out=out_0001_rl_trimmed.fq k=16 ktrim=l edist=2 restrictleft=40 ref=$primers
bbduk.sh in=out_0002_r_trimmed.fq out=out_0002_rl_trimmed.fq k=16 ktrim=l edist=2 restrictleft=40 ref=$primers
bbduk.sh in=out_0003_r_trimmed.fq out=out_0003_rl_trimmed.fq k=16 ktrim=l edist=2 restrictleft=40 ref=$primers
bbduk.sh in=out_0004_r_trimmed.fq out=out_0004_rl_trimmed.fq k=16 ktrim=l edist=2 restrictleft=40 ref=$primers
bbduk.sh in=out_0005_r_trimmed.fq out=out_0005_rl_trimmed.fq k=16 ktrim=l edist=2 restrictleft=40 ref=$primers
bbduk.sh in=out_0006_r_trimmed.fq out=out_0006_rl_trimmed.fq k=16 ktrim=l edist=2 restrictleft=40 ref=$primers
bbduk.sh in=out_0007_r_trimmed.fq out=out_0007_rl_trimmed.fq k=16 ktrim=l edist=2 restrictleft=40 ref=$primers
bbduk.sh in=out_0008_r_trimmed.fq out=out_0008_rl_trimmed.fq k=16 ktrim=l edist=2 restrictleft=40 ref=$primers
bbduk.sh in=out_0009_r_trimmed.fq out=out_0009_rl_trimmed.fq k=16 ktrim=l edist=2 restrictleft=40 ref=$primers
bbduk.sh in=out_0010_r_trimmed.fq out=out_0010_rl_trimmed.fq k=16 ktrim=l edist=2 restrictleft=40 ref=$primers
bbduk.sh in=out_0011_r_trimmed.fq out=out_0011_rl_trimmed.fq k=16 ktrim=l edist=2 restrictleft=40 ref=$primers
bbduk.sh in=out_0012_r_trimmed.fq out=out_0012_rl_trimmed.fq k=16 ktrim=l edist=2 restrictleft=40 ref=$primers
bbduk.sh in=out_0013_r_trimmed.fq out=out_0013_rl_trimmed.fq k=16 ktrim=l edist=2 restrictleft=40 ref=$primers
bbduk.sh in=out_0014_r_trimmed.fq out=out_0014_rl_trimmed.fq k=16 ktrim=l edist=2 restrictleft=40 ref=$primers
