...
./usearch8.0.1623_i86linux32 -fastx_truncate ../noprimermiddle_nochimeric.fasta -trunclen 1250 -label_suffix _l1250 -fastaout all_re_filtered_lentrim.fa

## sort reads by abundance
./usearch8.0.1623_i86linux32 -sortbylength all_re_filtered_lentrim.fa -fastaout all_re_filtered_trim1250_lensort.fasta
